...
let teksbio = `┆⫹⫺ 💌 Nama : Ren uwu
┆⫹⫺ ✉️ Nama RL : Ren Uwu
┆⫹⫺ ♂️ Gender : Pria
┆⫹⫺ 🕋 Agama : -
┆⫹⫺ ⏰ Tanggal lahir : Kepo km xD 
┆⫹⫺ 🎨 Umur : - 
┆⫹⫺ 🧮 Kelas : ga sekolah bg
┆⫹⫺ 🧩 Hobby : gada
┆⫹⫺ 💬 Sifat : ga asik
┆⫹⫺ 🗺️ Tinggal : pengen tinggal di isekai
└––––––––––––·•
`
...
𐚀 Chat Aɴᴇʜ Gᴀᴋ Jᴇʟᴀs Bᴀɴ/Bʟᴏᴄᴋ
...
{title: "⸙ Biodata Ren", rowId: ".owner bio"},
...
await conn.sendMessage(m.chat, { contacts: { displayName: wm, contacts: [{ vcard }] }}, { quoted: ftroli })
 ...
 conn.send2ButtonImg(m.chat, fs.readFileSync('./media/own.jpg').buffer, teksnomor, `Halo ${tag}\nIᴛᴜ Oᴡɴᴇʀ Kᴜ⫺⫰⫹\n` + botdate, `Sewa Bot`, `.sewa`, 'Menu', `.menu`, ftroli, { contextInfo: { externalAdReply: { showAdAttribution: true,
   ...
   conn.sendButton(m.chat, '┍┈༺ *𝙱𝚒𝚘𝙳𝚊𝚝𝚊 Ren* ༻', teksbio, ppown, [
                ['Sewa Bot', `${usedPrefix}sewa`],
                ['Menu', `${usedPrefix}menu`]
            ], m)
            break
                        case 'bio2':
          //conn.sendHydrated(m.chat, teksbio, wm, ppown, sig, "📷 Instagram", nomorown, '🌹 Nomor', [[null, null], [null, null],[null,null]], m)m)
            break
